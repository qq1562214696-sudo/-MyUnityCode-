...
public class 调色盘 : MonoBehaviour
{
    /// <summary>
    ...
    internal static void Create(Color currentColor, string v1, Action<Color> value1, Action<Color> colorFinished, bool v2, object value2, Vector2 buttonPosition, object realTime)
    {
    ...
    public void Drag()
    {
        ...
        Vector2 Transform = new(window.rect.width * transform.root.lossyScale.x, window.rect.height * transform.root.lossyScale.y);
